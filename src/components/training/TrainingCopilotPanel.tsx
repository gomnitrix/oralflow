...
export const TrainingCopilotPanel: React.FC<TrainingCopilotPanelProps> = ({
  ...
  return (
    <div
      className={`rounded-3xl border border-custom-border bg-white shadow-sm transition-all ${open
    ...
    >
      ...
      >
        <div>
          ...
          <p className="text-sm font-semibold text-custom-text-dark">
            {open ? "Training insights" : "Tap to expand"}
          </p>
        </div>
